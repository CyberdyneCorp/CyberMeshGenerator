...
// SCOPE (increment 1): this holds when the internal facet is recovered WITHOUT the
// carve removing either side — e.g. this bipyramid, whose wall is already a Delaunay
// face (zero Steiner). General internal-facet separation, where recovering the wall
// needs Steiner points, is a documented non-goal of this increment: the carve counts
